...
reject.01 = mt.reject(cbind(permT$rawp, permT$adjp), seq(0, 0.001, 0.0005))$r
print(paste("At 0.0005 significance level there are",reject.01[[3,1]],"probes without p-value correction and",reject.01[[3,2]],"with p-value correction"))
...
#Now let’s merge the expression and phenotypic data. 
...
```{r}
most.important<-c("X18183","X17751","X2508","X16939","X17796","X21780")
# most.important1<-c("SAAL1","TOMM22","SLC19A2","SYNC","ZNF69","TTC24")
